...
| `32-automated-pr-review.prose`        | Automated PR review with multi-perspective analysis                                                                                                         |
...
| `49-prose-run-retrospective.prose`                 | Post-run retrospective analysis and learnings extraction           |
| `50-run-endpoint-ux-test-with-remediation.prose`   | Endpoint UX test with automated issue remediation                  |
| `51-run-endpoint-ux-test-fast.prose`               | Lightweight fast endpoint UX test                                  |
